...
internal static class ServiceCollectionExtensions
{
    public static void AddSerilog(this ServiceCollection services)
    {
        ...
        var logFilePath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "LlamaRpg", "app.log");

        var logger = new LoggerConfiguration()
            .MinimumLevel.Debug()
            .WriteTo.RollingFile(@"C:\Users\Matteo\Desktop\logs.txt", flushToDiskInterval: flushInterval)
